...
const firebaseConfig = {
  ...
  //Por cuestiones de seguridad el apiKey no debería estar en el repo. Pero por cuestiones de prueba, lo he puesto aquí para facilitar la revisión de la prueba
